...
twoway_alcohol %>%
  ...
  emmeans_test(spend ~ genre, detailed = TRUE, p.adjust.method = "holm")
```
...
twoway_alcohol %>%
  group_by(genre) %>%
  emmeans_test(spend ~ alcohol_type, p.adjust.method = "holm", detailed = TRUE)
...
twoway_exam %>%
  group_by(difficulty) %>%
  t_test(grade ~ music, detailed = TRUE, paired = TRUE)
