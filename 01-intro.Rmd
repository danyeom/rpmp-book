...
This chapter is not meant to be an exhaustive be-all end-all to how to use R. It will only go through enough to complete RPMP's content. It will however introduce a couple of things that I think make for good starting habits using R, which is nice!
...
# this is also used but can be a bit hard to read
a.variable

# no spaces are allowed
a variable # This will give you an error
