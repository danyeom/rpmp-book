...
This section deals with some more advanced topics in regression. It serves as a continuation to the first chapter on regression, and in particular focuses on multiple regressions. This chapter will cover the following:
...
Up until now we have largely been talking about models with continuous outcomes. The t-test, ANOVA and most forms of regression have all been with continuous outcomes, for instance. But remember that we had a particular family of tests called the chi-square tests.
